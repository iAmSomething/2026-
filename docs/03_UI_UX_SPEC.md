...
| 운영 품질 패널(준비) | `GET /api/v1/dashboard/quality` | `poll_observations`, `articles`, `review_queue` | `generated_at`, `freshness_p50_hours`, `freshness_p90_hours`, `official_confirmed_ratio`, `needs_manual_review_count`, `source_channel_mix.article_ratio`, `source_channel_mix.nesdc_ratio` |
