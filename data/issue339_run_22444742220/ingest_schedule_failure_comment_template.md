...
evidence:
- workflow_run: https://github.com/iAmSomething/2026-/actions/runs/22444742220
- ingest_report: `data/ingest_schedule_report.json`
- classification_artifact: `data/ingest_schedule_failure_classification.json`
- dead_letter: `data/dead_letter/ingest_dead_letter_20260226T134421Z_http_5xx.json`
